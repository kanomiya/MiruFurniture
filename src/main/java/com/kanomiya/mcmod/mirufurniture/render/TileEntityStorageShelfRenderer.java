...
public class TileEntityStorageShelfRenderer extends IExtendedTileEntitySpecialRenderer<TileEntityStorageShelf> {
	...
	@Override public void renderTileEntityAt(TileEntityStorageShelf tileShelf, double posX, double posY, double posZ, float rot_rot, int p_180535_9_) {
